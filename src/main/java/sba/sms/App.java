...
public class App {
    ...
    public static void main(String[] args) {
        ...
        int userInput;
        do {
            log.info("Displaying main menu to user.");
            ...
            if (userInput == 1) {
                ...
                if (studentService.validateStudent(email, password)) {
                    log.info("Student validated successfully.");
                    ...
                    log.warning("Incorrect username or password entered.");
